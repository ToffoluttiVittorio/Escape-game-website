<?php
    ...
    $request1=mysqli_query($link, "SELECT * FROM objet");//commande SQL (adaptable) pour reçevoir que l'ID, si nécéssaire, on peut renvoyer des JSON directement si on utilise les bonnes commandes SQL
    if($reveur["data"]=="1"){
        $tableau=[];
